...
Source Host           : 192.168.80.9:3306
Source Database       : hawk

Target Server Type    : MYSQL
Target Server Version : 80026
File Encoding         : 65001

Date: 2021-09-02 23:47:39
*/
...
CREATE TABLE `t_diner` (
  ...
  `roles` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '角色',
...
-- Records of t_diner
-- ----------------------------
INSERT INTO `t_diner` VALUES ('1', 'abc', '昵称st', '13888888888', 'abc@imooc.com', 'e10adc3949ba59abbe56e057f20f883e', '/abc', 'ROLE_USER', '1', '2020-11-06 16:17:52', '2020-11-06 16:17:55');
INSERT INTO `t_diner` VALUES ('2', 'test', 'test', '13666666666', null, 'e10adc3949ba59abbe56e057f20f883e', '/test', 'ROLE_USER', '1', '2020-11-12 12:01:13', '2020-11-12 12:01:13');
INSERT INTO `t_diner` VALUES ('3', 'test2', 'test2', '13666666667', null, 'e10adc3949ba59abbe56e057f20f883e', '/test2', 'ROLE_USER', '1', '2020-11-12 17:47:12', '2020-11-12 17:47:12');
INSERT INTO `t_diner` VALUES ('5', 'aaa', 'aaa', '12311112222', null, 'e10adc3949ba59abbe56e057f20f883e', '/aaa', 'ROLE_USER', '1', '2020-11-13 12:29:49', '2020-11-13 12:29:49');
...
CREATE TABLE `t_feed` (
  ...
  `fk_diner_id` int DEFAULT NULL,
  `praise_amount` int DEFAULT NULL COMMENT '点赞数量',
  `comment_amount` int DEFAULT NULL COMMENT '评论数量',
  `fk_restaurant_id` int DEFAULT NULL,
  `create_date` datetime DEFAULT NULL,
  `update_date` datetime DEFAULT NULL,
  `is_valid` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `t_follow` (
  ...
  `follow_diner_id` int DEFAULT NULL,
  `is_valid` tinyint(1) DEFAULT NULL,
  `create_date` datetime DEFAULT NULL,
  `update_date` datetime DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  KEY `index_followeddiner_valid` (`follow_diner_id`,`is_valid`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `t_restaurant` (
  `id` int NOT NULL AUTO_INCREMENT,
  `Name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'the En Name of the restaurant',
  `CnName` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `X` double DEFAULT NULL,
  `Y` double DEFAULT NULL,
  `Location` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'En location of the restaurant',
  `CnLocation` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `Area` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'city.district.neighbourhood\r\nExample: Shanghai.Xuhui.Xujiahui',
  `CnArea` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `Traffic` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'the information/descripton of the restaurant',
  `Telephone` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Phone of the restaurant',
  ...
  `Cuisine` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `AveragePrice` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `AvgLunchPrice` decimal(19,0) DEFAULT NULL COMMENT 'Average price of lunch',
  `Introduction` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Indtroduction of the restaurant',
  `Status` int DEFAULT '0' COMMENT '1=Opened 0=Closed',
  `CreateDT` datetime DEFAULT NULL,
  `IsValid` smallint DEFAULT '1' COMMENT '1=Valid 0=Invalid',
  `Thumbnail` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'pics at the list, value would be:\r\nbasepath/original/picname',
  `OpenHours` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `LikeVotes` int DEFAULT '0' COMMENT 'the percentage of people like it',
  `DislikeVotes` int DEFAULT '0' COMMENT 'How many people votes',
  `Amenities` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '设备',
  `Tags` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'tags of the restaurant',
  `OpenDate` datetime DEFAULT NULL,
  `closeDate` datetime DEFAULT NULL,
  `CityId` int DEFAULT '21' COMMENT '城市id',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `index_isvalid` (`IsValid`) USING BTREE
...
-- ----------------------------
INSERT INTO `t_seckill_voucher` VALUES ('1', '2', '100', '2021-05-28 11:30:00', '2021-09-16 11:30:00', '1', '2021-09-01 23:42:38', '2021-09-01 23:42:38');
INSERT INTO `t_seckill_voucher` VALUES ('2', '1', '99', '2021-05-28 11:30:00', '2021-09-16 11:30:00', '1', '2021-09-01 23:44:57', '2021-09-01 23:44:57');
...
CREATE TABLE `t_voucher` (
  `id` int NOT NULL AUTO_INCREMENT,
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '代金券标题',
  `thumbnail` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '缩略图',
  `amount` int DEFAULT NULL COMMENT '抵扣金额',
  `price` decimal(10,2) DEFAULT NULL COMMENT '售价',
  `status` int DEFAULT NULL COMMENT '-1=过期 0=下架 1=上架',
  `expire_time` datetime DEFAULT NULL COMMENT '过期时间',
  `redeem_restaurant_id` int DEFAULT NULL COMMENT '验证餐厅',
  `stock` int DEFAULT '0' COMMENT '库存',
  `stock_left` int DEFAULT '0' COMMENT '剩余数量',
  `description` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '描述信息',
  `clause` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '使用条款',
  `create_date` datetime DEFAULT NULL,
  `update_date` datetime DEFAULT NULL,
  `is_valid` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `t_voucher_order` (
  ...
  `fk_voucher_id` int DEFAULT NULL,
  `fk_diner_id` int DEFAULT NULL,
  `qrcode` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '图片地址',
  `payment` tinyint DEFAULT NULL COMMENT '0=微信支付 1=支付宝支付',
...
-- ----------------------------
INSERT INTO `t_voucher_order` VALUES ('1', '1433098251166420992', '1', '2', null, null, '0', '2', '1', '2021-09-02 00:03:43', '2021-09-02 00:03:43', '1');
